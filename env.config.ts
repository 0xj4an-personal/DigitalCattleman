...
export const env = {
  ...
  APP_NAME: process.env.NEXT_PUBLIC_APP_NAME || 'Ganadero Digital',
  ...
  WALLET_CONNECT_PROJECT_ID: process.env.NEXT_PUBLIC_WALLET_CONNECT_PROJECT_ID || '881a95795846fe3dc63f02367f017450',
